...
import com.serbekun.inahosai.domain.http.dto.ReloadRes;
 ...
 *
 * <ul>
 *   <li>the route is not registered at all unless {@code INAHOSAI_ADMIN_TOKEN} is set —
...
public class AdminReload implements HttpHandler {
    ...
    public static final String TOKEN_ENV = "INAHOSAI_ADMIN_TOKEN";
